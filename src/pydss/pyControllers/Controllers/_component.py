...
MEASUREMENTS = (VariableSpec("measurement_voltage_pu"), VariableSpec("measurement_active_power"),
                VariableSpec("measurement_reactive_power"), VariableSpec("time_seconds"))
COMMANDS = (VariableSpec("command_active_power"), VariableSpec("command_reactive_power"),
...
class MigratedController(ControllerExplicitComponent):
    ...
    def compute_commands(self, inputs) -> Mapping[str, Any]:
        ...
        return {"command_active_power": settings.get("active_power", active_power),

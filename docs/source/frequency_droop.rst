...
==================================
(PvFrequencyRideThru.py)

Controls for DER frequency droop are integrated into the same controller module as frequency ride-through functionality. The PvFrequencyRideThru controller works with OpenDSS **Generator** objects and can be applied to one or more generators, modeling the frequency droop functionality as prescribed in IEEE 1547-2018.

Both frequency droop and frequency ride-through can be enabled at the same time from the same settings .toml file. 
...
| "Category I Low Frequency Droop" = true
| "OF2 - Hz" = 62.0
| "OF2 CT - sec" = 0.16
| "OF1 - Hz" = 61.2
| "OF1 CT - sec" = 300
